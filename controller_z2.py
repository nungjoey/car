...
# Form implementation generated from reading ui file '.\controller_zone2.ui'
#
...
class Ui_MainControllerZ2Window(object):
    def setupUi(self, MainControllerZ2Window):
        MainControllerZ2Window.setObjectName("MainControllerZ2Window")
        MainControllerZ2Window.resize(800, 600)
        self.centralwidget = QtWidgets.QWidget(MainControllerZ2Window)
...
"border-radius:5px;")
        ...
        MainControllerZ2Window.setCentralWidget(self.centralwidget)

        self.retranslateUi(MainControllerZ2Window)
        QtCore.QMetaObject.connectSlotsByName(MainControllerZ2Window)

    def retranslateUi(self, MainControllerZ2Window):
        _translate = QtCore.QCoreApplication.translate
        MainControllerZ2Window.setWindowTitle(_translate("MainControllerZ2Window", "Controller_zone1"))
        self.label.setText(_translate("MainControllerZ2Window", "Card ID :"))
        self.label_2.setText(_translate("MainControllerZ2Window", "การ์ดไอดี"))
        self.label_3.setText(_translate("MainControllerZ2Window", "ทะเบียน"))
        self.label_4.setText(_translate("MainControllerZ2Window", "ความสูง"))
        self.label_5.setText(_translate("MainControllerZ2Window", ":"))
        self.label_6.setText(_translate("MainControllerZ2Window", ":"))
        self.label_7.setText(_translate("MainControllerZ2Window", ":"))
        self.label_11.setText(_translate("MainControllerZ2Window", "โซน"))
        self.label_12.setText(_translate("MainControllerZ2Window", "ช่องจอด"))
        self.label_13.setText(_translate("MainControllerZ2Window", "หมายเลข"))
        self.label_14.setText(_translate("MainControllerZ2Window", ":"))
        self.label_15.setText(_translate("MainControllerZ2Window", ":"))
        self.label_16.setText(_translate("MainControllerZ2Window", ":"))
        self.label_20.setText(_translate("MainControllerZ2Window", "ZONE 2"))
