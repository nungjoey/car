...
class MainComtrollerz1Window(QMainWindow):
    def __init__(self):
        super(MainComtrollerz1Window, self).__init__()

        self.ui = Ui_MainControllerZ1Window()
    ...
    def call_lot(self):
        ...
        try:
                ...
                if old_zone_user==1:
                ...
                elif old_zone_user==2:
                    
                    if user_data_old[1] <= "190" and user_data_old[4] in z2:
                    ...
                    elif user_data_old[1] > "190" and user_data_old[4] in z2:
                        random_bay = random.choice([bay for bay in bay_order if bay not in z2])
                        new_zone = z1[random_bay]
...
if __name__ == "__main__":
    ...
    controllerz1window = MainComtrollerz1Window()
